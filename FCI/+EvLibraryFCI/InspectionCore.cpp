						  ...
						  BOOL bEncapLoc)
{
	...
	if (hCount < 1)
		return 0;
	HRegion hRegion_EncapLocation_magnus;
	HRegion hRegion_CropRemoveBlackLineMask_magnus;
	HRegion hRegion_EncapRemoveMask_magnus;
	HRegion hRegion_CropSmoothEncap_magnus;
	...
	GenRectangle1(&hRegion_CropRemoveBlackLineMask_magnus,
	...
	GenRectangle1(&hRegion_CropSmoothEncap_magnus,
		...
		m_TrainingData.hRect_CropSmoothEncap_magnus.right);

	HImage hDebugImageOutEncap;
	HRegion hDebugRegionOutEncap;
	HTuple hDebugMsgOutEncap;
	_FCI_Encap_RegionProjection(hImages, hRegion_EncapLocation_magnus,
		&hRegion_EncapLocation_magnus, &hDebugImageOutEncap, &hDebugRegionOutEncap, nStepDebug,
		hDeviceCenterRow, hDeviceCenterCol, hInspectRotationAngle, hInspectShiftAlongRow, hInspectShiftAlongCol, &hDebugMsgOutEncap);
	
	_FCI_Encap_RegionProjection(hImages, hRegion_CropRemoveBlackLineMask_magnus,
		&hRegion_CropRemoveBlackLineMask_magnus, &hDebugImageOutEncap, &hDebugRegionOutEncap, nStepDebug,
		hDeviceCenterRow, hDeviceCenterCol, hInspectRotationAngle, hInspectShiftAlongRow, hInspectShiftAlongCol, &hDebugMsgOutEncap);
	
	_FCI_Encap_RegionProjection(hImages, hRegion_CropSmoothEncap_magnus,
