		...
		HTuple *hv_IsPassEncap, HTuple *hv_DebugMessageOut)
{
	...
	HRegion		hRegion_EncapRemoveMask_magnus, hRegion_CropSmoothEncap_magnus, hRegion_CropNoSmoothEncap_magnus,
				hCrop_image_magnus, hBlack_Region_magnus, hWhite_Region_magnus, hDilation_WhiteRegion_magnus,
				hUnionRegion_WhiteBlack_magnus, hDiffRegion_magnus, hRegionOpening_fill_magnus,
	 			hConnection_opening_magnus, hRegionOpening_Select_magnus, hFillupRegion_diff_magnus, hRegionOpening_Circle_magnus,
				hRegionOpening_CircleCrop_magnus, hContour_Encap_magnus, hCropContour_After_magnus, hRegionContour_Smooth_magnus,
				hRegionInter_Smooth_magnus, hRegionInter_CropSmooth_magnus, hRegionInter_CropNoSmooth_magnus,
				hRegionUnion_2RegionSmooth_magnus, hRegionOpening_AfterSmooth_magnus, hRegionConnection_AfterSmooth_magnus, hRegionSelect_AfterSmooth_magnus;
	HTuple  hv_Message, hv_WidthOfEncap;
	HTuple  hv_Dummy;
	HTuple n_count=0;
	(*hv_IsPassEncap) = FALSE;
	GenEmptyObj(&(*ho_EncapLocation_final_magnus));
	Difference(ho_DeviceLocation, ho_CropRemoveBlackLineMask_magnus, &hRegion_EncapRemoveMask_magnus);
	Intersection(hRegion_EncapRemoveMask_magnus, ho_CropSmoothEncap_magnus, &hRegion_CropSmoothEncap_magnus);
	Difference(hRegion_EncapRemoveMask_magnus, hRegion_CropSmoothEncap_magnus, &hRegion_CropNoSmoothEncap_magnus);
	ReduceDomain(ho_Image, hRegion_EncapRemoveMask_magnus, &hCrop_image_magnus);
	
	if (0 != hv_IsStepMode)
	{
		hv_Message = "Segmented 1 magnus";
		_FCI_DebugParameters(ho_Image, hRegion_EncapRemoveMask_magnus, (*ho_DebugImageOut), (*ho_DebugRegionOut),
			&(*ho_DebugImageOut), &(*ho_DebugRegionOut), hv_Message, (*hv_DebugMessageOut),
			&(*hv_DebugMessageOut));
	}

	/////////// Threshold white and black region///////////////
	Threshold(hCrop_image_magnus, &hBlack_Region_magnus, 0, nThreshMax_Black_magnus);
	...
	Union2(hDilation_WhiteRegion_magnus, hBlack_Region_magnus, &hUnionRegion_WhiteBlack_magnus);
	...
	if (0 != hv_IsStepMode)
	{
		hv_Message = "Segmented remove black and white region magnus";
		_FCI_DebugParameters(ho_Image, hRegionOpening_fill_magnus, (*ho_DebugImageOut), (*ho_DebugRegionOut),
			&(*ho_DebugImageOut), &(*ho_DebugRegionOut), hv_Message, (*hv_DebugMessageOut),
			&(*hv_DebugMessageOut));
	}
	///////////////////////////////// Select shape and fillup////////
	Connection(hRegionOpening_fill_magnus, &hConnection_opening_magnus);
	RegionFeatures(hRegionOpening_fill_magnus, "width", &hv_WidthOfEncap);
	SelectShape(hConnection_opening_magnus, &hRegionOpening_Select_magnus, "width", "and", 0.5*hv_WidthOfEncap, 1.05*hv_WidthOfEncap);
	CountObj(hRegionOpening_Select_magnus, &n_count);
	if (n_count == 1)
	{
	...
	if (0 != hv_IsStepMode)
	{
		hv_Message = "Segmented Opening Circle magnus";
		_FCI_DebugParameters(ho_Image, hRegionOpening_Circle_magnus, (*ho_DebugImageOut), (*ho_DebugRegionOut),
			&(*ho_DebugImageOut), &(*ho_DebugRegionOut), hv_Message, (*hv_DebugMessageOut),
			&(*hv_DebugMessageOut));
	}
	...
	if (0 != hv_IsStepMode)
	{
		hv_Message = "Segmented smooth region magnus";
		_FCI_DebugParameters(ho_Image, hCropContour_After_magnus, (*ho_DebugImageOut), (*ho_DebugRegionOut),
			&(*ho_DebugImageOut), &(*ho_DebugRegionOut), hv_Message, (*hv_DebugMessageOut),
			&(*hv_DebugMessageOut));
	}
	/////// Gen region smooth
	GenRegionContourXld(hCropContour_After_magnus, &hRegionContour_Smooth_magnus, "filled");
	Intersection(hRegionContour_Smooth_magnus, hRegionOpening_Circle_magnus, &hRegionInter_Smooth_magnus);
	Intersection(hRegionInter_Smooth_magnus, hRegion_CropSmoothEncap_magnus, &hRegionInter_CropSmooth_magnus);

	//////////////////////// Get region no smooth  //////////
	Intersection(hRegion_CropNoSmoothEncap_magnus, hRegionOpening_Circle_magnus, &hRegionInter_CropNoSmooth_magnus);
	//m_arrayOverlayTeach.Add(hRegionInter_CropNoSmooth_magnus, colorYellow);
	...
	SelectShape(hRegionConnection_AfterSmooth_magnus, &hRegionSelect_AfterSmooth_magnus, "width", "and", 0.5*hv_WidthOfEncap, 1.05*hv_WidthOfEncap);
	...
	if (0 != hv_IsStepMode)
	{
		...
		_FCI_DebugParameters(ho_Image, (*ho_EncapLocation_final_magnus), (*ho_DebugImageOut), (*ho_DebugRegionOut),
			&(*ho_DebugImageOut), &(*ho_DebugRegionOut), hv_Message, (*hv_DebugMessageOut),
			&(*hv_DebugMessageOut));
	}
	/// display 
