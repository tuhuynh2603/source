...
#ifdef DIB_TOPDOWN
    int          GetHeight() const           { return (-1L)*m_DIBinfo.bmiHeader.biHeight;    } 
#endif
#ifndef DIB_TOPDOWN
...
public:
	...
	LPRGBQUAD GetColorPallete()           { return &m_DIBinfo.arColors[0];          }
    BOOL      SetColorTable(int nNumColors, RGBQUAD *pColors);
