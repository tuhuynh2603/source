...
//////
	///////////Encap bottom magnus
		...
		strVariable.Format("Teach Crop Encap Magnus Rect");
		pData->hRect_EncapLocation_magnus = ptrIniFile->GetCRect(strSec, strVariable, pData->hRect_EncapLocation_magnus);
		strVariable.Format("Teach Crop Smooth Encap Magnus Rect");
		pData->hRect_CropSmoothEncap_magnus = ptrIniFile->GetCRect(strSec, strVariable, pData->hRect_CropSmoothEncap_magnus);
		strVariable.Format("Teach Crop Mask remove Magnus Rect");
		pData->hRect_CropRemoveBlackLine_magnus = ptrIniFile->GetCRect(strSec, strVariable, pData->hRect_CropRemoveBlackLine_magnus);
...
////////
	...
	strVariable.Format("Teach Crop Mask remove Magnus Rect");
	ptrIniFile->SetCRect(strSec, strVariable, pData->hRect_CropRemoveBlackLine_magnus);
